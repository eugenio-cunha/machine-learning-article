...
desbalanceamento de acordo com o estudo de \citeauthoronline{ferreiraestudo} 
...
da classe majoritária. Além disso, \citeauthoronline{machado2009estudo} 
...
% O \textit{dataset} utilizado na indução foi fracionado em duas partes, esta 
...
\citeauthoronline{orange_documentation} (\citeyear{orange_documentation}). 
...
\textit{stopwords}. Segundo \citeauthoronline{matsubara2003pretext} 
...
de \citeauthoronline{tavares2007estudo} (\citeyear{tavares2007estudo}) explica 
